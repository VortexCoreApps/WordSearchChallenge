...
// ─── World Visual Themes ─────────────────────────────────────
// Each world gets a unique color palette, emoji, and accent
const WORLD_THEMES: { emoji: string; bg: string; accent: string; text: string; progressBar: string; glow: string }[] = [
...
const getTheme = (idx: number) => WORLD_THEMES[idx % WORLD_THEMES.length];
...
const LevelSelection: React.FC = () => {
    ...
    if (selectedBlockData && selectedBlockIndex !== null) {
        ...
        const theme = getTheme(selectedBlockIndex);
